        ...
        @can('team_competition_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.team-competitions.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/team-competitions") || request()->is("admin/team-competitions/*") ? "c-active" : "" }}">
                    ...
                    {{ trans('cruds.teamCompetition.title') }}
                </a>
            </li>
        @endcan
        @can('tim_lomba_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.tim-lombas.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/tim-lombas") || request()->is("admin/tim-lombas/*") ? "c-active" : "" }}">
                    <i class="fa-fw fab fa-teamspeak c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.timLomba.title') }}
                </a>
            </li>
        @endcan
