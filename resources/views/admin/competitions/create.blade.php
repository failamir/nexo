    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.competitions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_lomba') ? 'is-invalid' : '' }}" type="text" name="nama_lomba" id="nama_lomba" value="{{ old('nama_lomba', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah_submission') ? 'is-invalid' : '' }}" type="number" name="jumlah_submission" id="jumlah_submission" value="{{ old('jumlah_submission', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('biaya') ? 'is-invalid' : '' }}" type="number" name="biaya" id="biaya" value="{{ old('biaya', '') }}" step="1">
                @if($errors->has('biaya'))
                    <div class="invalid-feedback">
                        {{ $errors->first('biaya') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tanggal_selesai') ? 'is-invalid' : '' }}" type="text" name="tanggal_selesai" id="tanggal_selesai" value="{{ old('tanggal_selesai', '') }}">
