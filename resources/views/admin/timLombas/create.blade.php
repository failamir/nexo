...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.timLomba.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tim-lombas.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_tim') ? 'is-invalid' : '' }}" type="text" name="nama_tim" id="nama_tim" value="{{ old('nama_tim', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('institusi') ? 'is-invalid' : '' }}" type="text" name="institusi" id="institusi" value="{{ old('institusi', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomor_kontak_1') ? 'is-invalid' : '' }}" type="text" name="nomor_kontak_1" id="nomor_kontak_1" value="{{ old('nomor_kontak_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomor_kontak_2') ? 'is-invalid' : '' }}" type="text" name="nomor_kontak_2" id="nomor_kontak_2" value="{{ old('nomor_kontak_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_anggota_1') ? 'is-invalid' : '' }}" type="text" name="nama_anggota_1" id="nama_anggota_1" value="{{ old('nama_anggota_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_anggota_1') ? 'is-invalid' : '' }}" type="email" name="email_anggota_1" id="email_anggota_1" value="{{ old('email_anggota_1') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_anggota_2') ? 'is-invalid' : '' }}" type="text" name="nama_anggota_2" id="nama_anggota_2" value="{{ old('nama_anggota_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_anggota_2') ? 'is-invalid' : '' }}" type="email" name="email_anggota_2" id="email_anggota_2" value="{{ old('email_anggota_2') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_anggota_3') ? 'is-invalid' : '' }}" type="text" name="nama_anggota_3" id="nama_anggota_3" value="{{ old('nama_anggota_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_anggota_3') ? 'is-invalid' : '' }}" type="email" name="email_anggota_3" id="email_anggota_3" value="{{ old('email_anggota_3') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_anggota_4') ? 'is-invalid' : '' }}" type="text" name="nama_anggota_4" id="nama_anggota_4" value="{{ old('nama_anggota_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_anggota_4') ? 'is-invalid' : '' }}" type="text" name="email_anggota_4" id="email_anggota_4" value="{{ old('email_anggota_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('simpan_permanen') ? 'is-invalid' : '' }}" type="number" name="simpan_permanen" id="simpan_permanen" value="{{ old('simpan_permanen', '0') }}" step="1">
