            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.user.fields.e_ktm') }}
                        </th>
                        <th>
                            {{ trans('cruds.user.fields.bukti_twibbon') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($users as $key => $user)
                        <tr data-entry-id="{{ $user->id }}">
                            ...
                            <td>
                                @if($user->e_ktm)
                                    <a href="{{ $user->e_ktm->getUrl() }}" target="_blank" style="display: inline-block">
                                        <img src="{{ $user->e_ktm->getUrl('thumb') }}">
                                    </a>
                                @endif
                            </td>
                            <td>
